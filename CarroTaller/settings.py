"""
Django settings for CarroTaller project.
...
ROOT_URLCONF = 'CarroTaller.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            'CarroTaller/Templates/'
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'CarroTaller.wsgi.application'
...
DATABASES = {
    'siesa': {
        'ENGINE': os.getenv('ENGINE_SQL', 'django.db.backends.dummy'),
